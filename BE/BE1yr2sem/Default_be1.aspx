<%@ Page Language="C#" AutoEventWireup="false" CodeFile="Default_be1.aspx.cs" Inherits="Default" MasterPageFile="~/formMasterPage.master"  %>
...
function handleKeyUpEvent(elementRef)
{
 ...
 if ( (elementRef) && (elementRef.value.length >= elementRef.maxLength) && (elementRef.focusToElement) )
 {
  document.getElementById(elementRef.focusToElement).focus();
    ...
    <div>
    <h3><span style="color: black">B.E. First Year II Sem Theory</span></h3>
     ...
     Enter Student Roll No here:</strong><asp:TextBox ID="rollno" runat="server" MaxLength="8" TabIndex="1"></asp:TextBox>
       ...
       <table  cellspacing="0"  class="header" style="font-size: 11pt">
                ...
                <td align="center" style="width: 59px; height: 25px;">
                    <strong><span style="font-size: 11pt">M-II</span></strong></td>
                <td style="width: 50px; height: 25px;" align="center">
                    <strong><span style="font-size: 11pt">PHY</span></strong></td>
                <td align="center" style="width: 50px; height: 25px;">
                    <strong><span style="font-size: 11pt">CHE</span></strong></td>
                <td align="center" style="width: 50px; height: 25px;">
                    <strong><span style="font-size: 11pt">BECE</span></strong></td>
                <td align="center" style="width: 50px; height: 25px;">
                    <strong><span style="font-size: 11pt">OOP</span></strong></td>
                <td align="center" style="width: 50px; height: 25px;">
                    <strong><span style="font-size: 11pt">BEE</span></strong></td>
                </tr>
                </thead>
