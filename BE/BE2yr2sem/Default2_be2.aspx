<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2_be2.aspx.cs" Inherits="Default2"   MasterPageFile="~/formMasterPage.master"%>
...
<h3><span style="color: black">B.E. Second Year II Sem Practicals</span></h3>
<center><strong>
...
<br />
    ...
    <table  cellspacing="0"  class="header" style="width: 611px; font-size: 11pt"  >
                ...
                <td align="left" style="width: 59px; height: 25px;">
                    <strong><span style="font-size: 11pt">OOP LAB</span></strong></td>
                <td style="width: 50px; height: 25px;" align="center">
                    <span style="font-size: 11pt"><strong>μP LAB</strong></span></td>
