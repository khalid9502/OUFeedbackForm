<%@ Page Language="C#" AutoEventWireup="false" CodeFile="Default_be2.aspx.cs" Inherits="Default" MasterPageFile="~/formMasterPage.master"  %>
...
function handleKeyUpEvent(elementRef)
{
 ...
 if ( (elementRef) && (elementRef.value.length >= elementRef.maxLength) && (elementRef.focusToElement) )
 {
  document.getElementById(elementRef.focusToElement).focus();
    ...
    <div>
    <h3>
        <span style="color: black">B.E. Second Year II Sem Theory</span></h3>
     ...
     Enter Student Roll No here:</strong><asp:TextBox ID="rollno" runat="server" MaxLength="8" TabIndex="1"></asp:TextBox>
       ...
       <table  cellspacing="0"  class="header" style="font-size: 11pt">
                ...
                <td style="width: 12px; height: 25px;" align="left">
                ...
                <td align="center" style="width: 59px; height: 25px;">
                    <strong><span style="font-size: 11pt">DE</span></strong></td>
                <td style="width: 53px; height: 25px;" align="center">
                    <strong><span style="font-size: 11pt">M-IV</span></strong></td>
                <td align="center" style="width: 51px; height: 25px;">
                    <strong><span style="font-size: 11pt">OOPJ</span></strong></td>
                <td align="center" style="width: 55px; height: 25px;">
                    <span style="font-size: 11pt"><strong>μP</strong></span></td>
                <td align="center" style="width: 52px; height: 25px;">
                    <strong><span style="font-size: 11pt">PL</span></strong></td>
                <td align="center" style="width: 49px; height: 25px;">
