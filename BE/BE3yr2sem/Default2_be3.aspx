<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2_be3.aspx.cs" Inherits="Default2"   MasterPageFile="~/formMasterPage.master"%>
...
<h3><span style="color: black">B.E. Third Year II Sem Practicals</span></h3>
<center><strong>
...
<br />
    ...
    <table  cellspacing="0"  class="header" style="width: 611px; font-size: 11pt"  >
                ...
                <td style="width: 368px; height: 25px;" align="left">
                    <strong><span style="font-size: 11pt;">Practicals</span></strong></td>
                <td align="left" style="width: 58px; height: 25px;">
                    <strong><span style="font-size: 11pt">CN LAB</span></strong></td>
                <td style="width: 61px; height: 25px;" align="center">
                    <strong><span style="font-size: 11pt">WP LAB</span></strong></td>
            ...
            <tr style="background-color:#EFF3FB;" >
                ...
                <td style="width: 50px" align="center"><asp:TextBox ID="txt12"  runat="server" Width="50px" MaxLength="1"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txt12" />
            ...
            <tr >
               ...
               <asp:RangeValidator ID="RangeValidator3" runat="server" ErrorMessage="*" Display="Dynamic" 
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="txt22" />
            ...
            <tr   style="background-color:#EFF3FB;" >
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="txt32" />
                <asp:RangeValidator ID="RangeValidator6" runat="server" ErrorMessage="*" Display="Dynamic" 
                    SetFocusOnError="true" ControlToValidate="txt32" MaximumValue="6" MinimumValue="1" /></td>
            ...
            <tr >
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txt42" />
                <asp:RangeValidator ID="RangeValidator8" runat="server" ErrorMessage="*" Display="Dynamic" 
                    SetFocusOnError="true" ControlToValidate="txt42" MaximumValue="6" MinimumValue="1" /></td>
            ...
            <tr   style="background-color:#EFF3FB;" >
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" ControlToValidate="txt52" />
                <asp:RangeValidator ID="RangeValidator10" runat="server" ErrorMessage="*" Display="Dynamic" 
                    SetFocusOnError="true" ControlToValidate="txt52" MaximumValue="6" MinimumValue="1" /></td>
