<%@ Page Language="C#" AutoEventWireup="false" CodeFile="Default_mtech1.aspx.cs" Inherits="Default" MasterPageFile="~/formMasterPage.master"  %>
 ...
 if ( (elementRef) && (elementRef.value.length >= elementRef.maxLength) && (elementRef.focusToElement) )
 {
  document.getElementById(elementRef.focusToElement).focus();
    ...
    <h3>
        ...
        M.Tech{CSE} First Year II Sem Theory</span></h3>
       ...
       <center>
        <table  cellspacing="0"  class="header" style="font-size: 11pt" >
                ...
                <td style="width: 50px; height: 25px;" align="center">
                    <strong><span style="font-size: 11pt">AD</span></strong></td>
                ...
                <td align="center" style="width: 50px; height: 25px;">
                    <strong><span style="font-size: 11pt">SRT</span></strong></td>
                </tr>
                </thead>
